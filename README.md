...
3. Decision workflow for how to install the Opentelmetry Collector in Kubernetes 
...
| AWS ECS Fargate        | [Link](./instrumentation/java/aws-ecs)  <br>  [Without Collector](./instrumentation/java/aws-ecs-fargate-without-collector)  <br>[AppD Dual Ingest](./instrumentation/java/aws-ecs-appd-dual-ingest) | [Link](./instrumentation/dotnet/aws-ecs)                                                                                                        | [Link](./instrumentation/nodejs/aws-ecs)                                                                                | [Link](./instrumentation/python/aws-ecs)                | [Link](./instrumentation/go/aws-ecs)                |
